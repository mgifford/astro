...
import { InvalidFrontmatterInjectionError } from '../core/errors/errors-data.js';
		...
		async load(id) {
			if (isMarkdownFile(id)) {
				...
				if (astroData instanceof InvalidAstroDataError) {
					throw new AstroError(InvalidFrontmatterInjectionError);
				}
				...
				import { AstroError, MarkdownImageNotFound } from ${JSON.stringify(astroErrorModulePath)};
